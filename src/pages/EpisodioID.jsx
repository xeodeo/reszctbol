...
export default function EpisodioID() {
  {
    ...
    const fetchCharacter = async () => {
      ...
      try {
        ...
        if (!response.ok) {
          throw new Error(`No se encontró el Capitulo con ID ${parsedId}.`);
        }
    ...
    return (
      <div style={{ maxWidth: 640, margin: "0 auto", padding: 16 }}>
        ...
        <h1>Buscar Episodio por ID</h1>
        <p>Ingresa un número de ID y presiona "Buscar" para obtener un Episodio.</p>
        ...
        {character && (
          ...
          >
            ...
            <ul style={{ listStyle: "none", padding: 0, marginTop: 12 }}>
              ...
              <li>
                <strong>Fecha de emicion:</strong> {character.air_date}
              </li>
              <li>
                <strong>Codigo de episocio:</strong> {character.episode}
              </li>
              <li>
